...
public class LeshanSmartFarmStandalone {

    private static final Logger LOG = LoggerFactory.getLogger(LeshanSmartFarmStandalone.class);

    private Server server;
    private SmartFarmServer lwServer;
    ...
    public void start() {
        ...
        // Build LWM2M server
        SmartFarmServerBuilder builder = new SmartFarmServerBuilder();
    ...
    public static void main(String[] args) {
        new LeshanSmartFarmStandalone().start();
    }
}