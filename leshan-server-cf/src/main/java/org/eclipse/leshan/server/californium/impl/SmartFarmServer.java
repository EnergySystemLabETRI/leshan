 ...
 * </p>
 * <p>
 * The {@link SmartFarmServerBuilder} should be the preferred way to build an instance of {@link SmartFarmServer}.
 * </p>
 */
public class SmartFarmServer implements LwM2mServer {

    private final CoapServer coapServer;

    private static final Logger LOG = LoggerFactory.getLogger(SmartFarmServer.class);
    ...
    final OneM2mCseRegisterResource cseRegisterResource;
     ...
     */
    public SmartFarmServer(InetSocketAddress localAddress, InetSocketAddress localAddressSecure,
        ...
        this.clientRegistry.addListener(new ClientRegistryListener() {
            ...
            public void unregistered(final Client client) {
                SmartFarmServer.this.observationRegistry.cancelObservations(client);
            }
        ...
        // define /OneM2mCseRegisterResource resource
        cseRegisterResource = new OneM2mCseRegisterResource("base1");
        
        coapServer.add(rdResource);
        coapServer.add(cseRegisterResource);
    ...
    public OneM2mCseRegisterResource getCseRegisterResource() {
		return cseRegisterResource;
	}
